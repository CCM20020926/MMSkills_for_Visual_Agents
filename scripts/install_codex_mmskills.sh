...
SKILL_PATH="agent_integrations/mmskills"
CODEX_HOME="${CODEX_HOME:-$HOME/.codex}"
DEST="$CODEX_HOME/skills/mmskills"
INSTALLER="$CODEX_HOME/skills/.system/skill-installer/scripts/install-skill-from-github.py"

if [ -e "$DEST" ]; then
  echo "MMSkills Codex skill already exists at $DEST"
...
echo "Installed MMSkills Codex skill at $DEST"
